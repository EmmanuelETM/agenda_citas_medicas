<script>
    ...
    let medico_id = $page.params.medico_id;
    let hora = "";
    let fecha = "";
    let tipo_cita = "";
    let motivo = "";

    async function handleCita(event){
            ...
            <div class="col-start-4 col-end-10 mx-auto md:h-screen lg:py-0">
                <div class="w-full bg-white rounded-lg shadow dark:border sm:max-w-xl xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form on:submit={handleCita} class="flex flex-col space-y-4 md:space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="message" bind:value={motivo} rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..."></textarea>
                            </div>
