...
<main class="p-4 md:ml-64 h-auto pt-20">
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <nav class="grid rounded-lg col-start-1 col-end-5 row-start-1 row-end-1 items-center justify-between p-4 bg-gray-800 text-white">
            ...
            <div class="searchbar row-start-1 col-start-1 col-end-5">
                <form class="max-w-lg mx-auto">
                    <div class="flex">
                        <label for="search-dropdown" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Your Email</label>
                        <button id="dropdown-button" data-dropdown-toggle="dropdown" class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600" type="button">Categorias<svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                ...
                <!-- Pagination -->
        <div class="col-start-1 col-end-2 row-start- row-end-3 sm:row-start-7 sm:row-end-8">
        ...
        <div class="col-start-1 col-end-5 row-start-4 sm:row-start-9">
            <Table/>
        </div>
    </div>
</main>
