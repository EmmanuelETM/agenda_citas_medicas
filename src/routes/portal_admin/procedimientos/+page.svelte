<script>
    ...
    import Buttons from "./components_procedimientos/buttons.svelte"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-3">Id Procedimiento</th>
                    ...
                    <tbody>
                        {#each procedimientos as proc}
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{proc.procedimiento_id}</th>
                                <td class="px-4 py-3">{proc.nombre}</td>
                                <td class="px-4 py-3">{proc.descripcion}</td>
                                <td class="px-4 py-3">
                                    <Buttons/>
                                </td>
                            </tr>
