            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-3">Id Consultorio</th>
                            <th scope="col" class="px-4 py-3">Numero</th>
                            <th scope="col" class="px-4 py-3">Ubicacion</th>
                    ...
                    <tbody>
                        {#each consultorios as consultorio}
                            <tr class="border-b dark:border-gray-700">
                                <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">{consultorio.consultorio_id}</th>
                                <td class="px-4 py-3">{consultorio.numero}</td>
                                <td class="px-4 py-3">{consultorio.ubicacion}</td>
                                <td class="px-4 py-3">
                                    <Buttons/>
                                </td>
                            </tr>
